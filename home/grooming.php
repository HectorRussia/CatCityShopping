...
<body>
            ...
            <table class="table table-bordered text-center w-50 m-auto mt-3">
                ...
                <tbody>
                    ...
                    {   
                        ...
                        if($show_status=='available')
                        {
                            echo "
                            <form action='reserve_grooming.php' method='post' class='mb-2'>
                                <tr>                        
                                    <td>$showtime</td>
                                    <td>$show_status</td>
                                    <td>
                                        <input type='hidden' name='show_status' value='$show_status'>
                                        <input type='hidden' name='time_id' value='$time_id'>
                                        <button type='submit' class='btn btn-info' name='reserve'><i class='fa-solid fa-plus'></i></button>
                                    </td>                       
                                </tr>
                            </form>                               
                            ";
                            ...
                            <form action='' method='post' class='mb-2'>
                                <tr>                        
                                    ...
                                    <td>
                                        <input type='hidden' name='show_status' value='$show_status'>
                                        <input type='hidden' name='time_id' value='$time_id'>
                                        <button type='submit' class='btn btn-danger' name='reserve'><i class='fa-solid fa-xmark fa-lg'></i></button>
                                    </td>                       
                                </tr>
                            </form>                               
                            ";
    ...
    <?php
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reserve'])) 
        {
            ...
            if($showstatus=='available')
            {
                
            }
            else
            {
                echo "<script>alert('The current time slot is fully booked. Please choose another time slot')</script>";
            }
        }
    ?>
    <div class="mt-5">
