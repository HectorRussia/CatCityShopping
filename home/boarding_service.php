...
<body>
        ...
        <div class="container mt-2 fade-in">
                <div style="padding-left: 17%;">
                    <h4 style="color: #1151c0;"><img src="../image/home_index/2.jpg" style="width: 200px;"><b>Welcome to Cat boarding service</b><img src="../image/home_index/2.jpg" style="width: 200px;"></h4>
                </div>
            <br>
        </div>         
        ...
        <div class="container A mb-3">
            ...
            ?>
            <form action='../user_payment/cat_boarding_finish.php' method='post'>
                <ul class='list-unstyled mb-1-9'>
                    ...
                    <li class='mb-2 mb-xl-3 display-28'><span class='display-26 text-secondary me-2 font-weight-600'>Start: </span>
                    <input type='text' name='start' class='form-control w-50'  placeholder='11/9/2023' required></input></li>
                    
                    <li class='mb-2 mb-xl-3 display-28'><span class='display-26 text-secondary me-2 font-weight-600'>collect : </span>
                    <input type='text' name='end' class='form-control w-50'  placeholder='14/9/2023' required></input></li>

                    <li class='mb-2 mb-xl-3 display-28'>
                        <span class='display-26 text-secondary me-2 font-weight-600'>Detail cat </span>
                        <textarea name='detail_boarding' class='form-control w-50' placeholder='Shy, likes to play with other cats' required></textarea>
                    </li>
                    
                    <div class='form-outline mb-4'>
                        <input type='submit' name='boarding' class='btn btn-info mb-3 px-3 mt-4'
                        value='Reserve cat boarding'>
                    </div>
                </ul>
            </form>
        </div>
