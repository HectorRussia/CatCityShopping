    ...
    <div class="container mt-3 ">       
            ...
            ?>
                ...
                <div class='form-outline mb-4 w-50 m-auto' style="display: flex; align-items: center;">
                    <label for='user_name' class='form-label'><h4>Please check info cat</h4></label>
                </div>
                ...
                <!--banking img-->
                <div class='form-outline mb-4 w-50 m-auto'>
                    <label for='user_name' class='form-label'><h3>Banking</h3></label>
                    <br>
                </div>
                ...
                <!--QR code img-->
                <div class='form-outline mb-4 w-50 m-auto'>
                    <label for='user_name' class='form-label'><h3>QR-code</h3></label>
                    <br>
                </div>
                <img src='../image/IMG_4609.png' alt='' class='QR'> 
                
                <!-- form for payment -->
                <form action="../user_payment/payment_cat.php" method="post" enctype="multipart/form-data">
