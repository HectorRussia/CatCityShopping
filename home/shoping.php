...
<body>
        ...
        <div class="container mt-2 fade-in">
                ...
                <div style="padding-left: 25%;">
                    <h4 style="color: #1151c0;"><img src="../image/home_index/2.jpg" style="width: 200px;"> <b> Let's shoping  </b>  <img src="../image/home_index/2.jpg" style="width: 200px;"></h4>
                </div>
            <br>
                    
            <!--ตรงนี้จะเป็นหัวข้อของพวกสินค้ามีตระกร้าและก็ตัวค้นหา-->
                
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link" href="shoping.php">Show all</a>
                    </li>
                    <!--
                    <li class="nav-item">
                        <a class="nav-link" href="shoping.php?pellet_food">Pellet food</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="#">Wet food</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Barf</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="#">Cage</a>
                    </li>
                    ...
                    <form class="form-inline" action="search_product.php" method="get">
                        ...
                        <button class="btn btn-outline-success my-2 my-sm-0" value="Search" name="search_data_product" type="submit">Search</button>
                    </form>
        ...
        <div class="container mt-4 fade-in">
            <div class="row">
                <!-- Show product cards here -->

                <?php

                    //เวลาadd ของเข้าตระกร้า
                    add_to_cart();
                ...
                <!-- Repeat the above card block for each product -->
