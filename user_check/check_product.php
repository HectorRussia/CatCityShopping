...
<body>
        ...
        <div class="container mt-2 fade-in">
                <div style="padding-left: 16%;">
                    <h4 style="color: #1151c0;"><img src="../image/home_index/2.jpg" style="width: 200px;"><b>Purchase history</b><img src="../image/home_index/2.jpg" style="width: 200px;"></h4>
                </div>
            <br>
        </div>         
        ...
        <?php
            ...
            $user_id = getUserId();
            $select_product = "SELECT * FROM orders_pending WHERE user_id= $user_id ORDER BY order_id DESC";
            ...
            {   echo 
                ...
                {   
                    ...
                    $select_productID="SELECT * FROM add_products WHERE product_id=$product_id";
                    $result_productID=mysqli_query($mysqli,$select_productID);
                    $row_productID=mysqli_fetch_assoc($result_productID);
                    $product_name=$row_productID['product_name'];
                    $product_price=$row_productID['product_price'];
                    $product_image=$row_productID['product_image1'];
                    ...
                    echo "
                            <tr>                        
                                <td>$product_name</td>
                                <td><img src='../admin_cat/product_images/$product_image' class='product_img'></td>
            ...
            else
            {
                echo "
                        <tr>                        
                            <h2 class='text-center text-danger'>Not have buy Product</h2> 
                        </tr>
