...
<body>
        ...
        <div class="container mt-2 fade-in">
                <div style="padding-left: 16%;">
                    <h4 style="color: #1151c0;"><img src="../image/home_index/2.jpg" style="width: 200px;"><b>This is a  appointment cat boading</b><img src="../image/home_index/2.jpg" style="width: 200px;"></h4>
                </div>
            <br>
        </div>         
        ...
        <?php
            $user_id = getUserId();
            $select_board = "SELECT * FROM cat_boarding WHERE user_id= $user_id";
            $result_board = mysqli_query($mysqli, $select_board);
            $number_row = mysqli_num_rows($result_board);
            ...
            {   echo 
                ...
                ";
                while ($row = mysqli_fetch_assoc($result_board)) 
                {   
                    $name_cat=$row['name_cat'];
                    $start=$row['start_board'];
                    $end=$row['end_board'];
                    $detail_cat=$row['detail_boarding'];
            ...
            else
            {
                echo "
                <tr>                        
                    <h2 class='text-center text-danger'>Not have appointment cat boarding</h2> 
                </tr>
                ";
            }
        ?>
