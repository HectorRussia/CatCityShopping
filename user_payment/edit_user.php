        ...
        <div class="container A">
            <div class="col-lg-12 px-xl-12">
                ...
                <div class='row'>
                    ...
                    <div class='col-2 d-flex align-items-center justify-content-center ml-4'>
                        <a href='#' class='icon display-4'><i class='fa-solid fa-bath' style='color: #2e75d1;'></i></a>
                    </div>
                    <div class='col-2 d-flex align-items-center justify-content-center ml-1'>
                        <a href='#' class='icon display-4'><i class='fa-solid fa-paw' style='color: #a2ad0b;'></i></a>
                    </div>
                </div>
                <div class='row'>
                    <div class='col-2'>
                ...
                <div class='row'>
                    <div class='col-2 d-flex align-items-center justify-content-center ml-4'>
                        <a href='#' class='icon display-4'><i class='fa-solid fa-cat' style='color: #7a9ee1;'></i></a>
                    </div>
                    <div class='col-2 d-flex align-items-center justify-content-center ml-4'>
                        <a href='#' class='icon display-4'><i class='fa-solid fa-truck' style='color: #b51261;'></i></a>
                    </div>
                </div>
            </div>
        </div>
