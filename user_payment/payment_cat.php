...
if (isset($_POST['user_id']) && isset($_POST['payment'])) 
{
    ...
    $select_total = "SELECT DISTINCT Total_price FROM cat_orders WHERE user_id = $user_id ORDER BY order_date DESC";
    ...
    {
        move_uploaded_file($temp_image, "../admin_cat/evident_money_cat/$image_qr");
        $insert_payment = "INSERT INTO complete_buy_cat (user_id, total_price, image_qr, date)  VALUES ('$user_id', '$total_price', '$image_qr', NOW())";
...
else 
{
    ...
    header("Location:../home/shoping.php");
    exit;
}
?>
